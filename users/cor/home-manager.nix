...

{
  ...
  home.packages = [
    ...
    pkgs.curl
    pkgs.pamixer
    (pkgs.writeShellScriptBin "feh-bg-fill" ''
      feh --bg-fill /home/cor/.background-image
    '')
    (pkgs.writeShellScriptBin "xr-mbp" ''
      ...
      feh-bg-fill
    '')
    (pkgs.writeShellScriptBin "xr-mbp-1.5" ''
      ...
      feh-bg-fill
    '')
    (pkgs.writeShellScriptBin "xr-uw" ''
      ...
      feh-bg-fill
    '')
    (pkgs.writeShellScriptBin "xr-5120" ''
      ...
      feh-bg-fill
    '')
    (pkgs.writeShellScriptBin "xr-3840" ''
      ...
      feh-bg-fill
    '')
    (pkgs.writeShellScriptBin "xr-5760" ''
      ...
      feh-bg-fill
    '')    
    (pkgs.writeShellScriptBin "xr-6400" ''
      ...
      feh-bg-fill
    '')
    (pkgs.writeShellScriptBin "reload-config" ''
